...
fix_ner_tags('stanford-wikipedia-training.txt', 'stanford-wikipedia-training-corrected.txt')
fix_ner_tags('stanford-fanwiki-training.txt', 'stanford-fanwiki-training-corrected.txt')
